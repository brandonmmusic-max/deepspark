...
def warmup_kernels(
    ...
    if (
        ...
        # DSpark+B12X already exercises target and draft graphs during profile and
        # capture. This synthetic warmup can manufacture sparse top-k metadata that
        # real scheduler requests do not use, so skip it for the DSpark path.
        return
