...
class ModelRunnerOutput:
    ...
    # req_id -> draft prefix length proposed for the next async speculative
    # step. DSpark P2 uses this to vary placeholder lengths while keeping
    # draft token IDs resident on the worker.
    draft_token_counts: dict[str, int] | None = None
