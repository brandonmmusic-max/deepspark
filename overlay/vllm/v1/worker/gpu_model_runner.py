...
class AsyncGPUModelRunnerOutput(AsyncModelRunnerOutput):
    def __init__(
        ...
        draft_token_count_req_ids: list[str] | None = None,
        draft_token_counts: torch.Tensor | None = None,
    ):
        self._model_runner_output = model_runner_output
        self._invalid_req_indices = invalid_req_indices
        self._draft_token_count_req_ids = draft_token_count_req_ids
        ...
        self._draft_token_counts = draft_token_counts
        ...
        with torch.cuda.stream(async_output_copy_stream):
            ...
            self._draft_token_counts_cpu = (
                self._draft_token_counts.to("cpu", non_blocking=True)
                if self._draft_token_counts is not None
                else None
            )
    ...
    def get_output(self) -> ModelRunnerOutput:
        ...
        if (
            self._draft_token_counts_cpu is not None
            and self._draft_token_count_req_ids is not None
        ):
            counts = self._draft_token_counts_cpu.tolist()
            output.draft_token_counts = {
                req_id: int(count)
                for req_id, count in zip(self._draft_token_count_req_ids, counts)
            }
        del self._draft_token_counts
...
class GPUModelRunner(
    ...
    def __init__(
        ...
        self._draft_token_count_req_ids: list[str] | None = None
        self._draft_token_counts: torch.Tensor | None = None
    ...
    def sample_tokens(
        ...
        self._draft_token_count_req_ids = None
        self._draft_token_counts = None
        ...
        with record_function_or_nullcontext(
            ...
            async_output = AsyncGPUModelRunnerOutput(
                ...
                draft_token_count_req_ids=self._draft_token_count_req_ids,
                draft_token_counts=self._draft_token_counts,
            )
        with record_function_or_nullcontext(
    ...
    def propose_draft_token_ids(
        ...
        if spec_config.method == "ngram":
            ...
            if isinstance(self.drafter, DSparkProposer):
                draft_counts = self.drafter.take_last_scheduled_draft_lengths()
                if draft_counts is not None:
                    self._draft_token_counts = draft_counts
                    self._draft_token_count_req_ids = self.input_batch.req_ids.copy()
    ...
    def _get_eagle3_aux_layers_from_config(self) -> tuple[int, ...] | None:
        ...
        if not layer_ids:
            ...
            if not layer_ids and dspark_target_layer_ids:
                # DSpark's config follows the reference implementation:
                # target ids are zero-based decoder layer ids captured
                # after the layer has run.
                layer_ids = [i + 1 for i in dspark_target_layer_ids]
